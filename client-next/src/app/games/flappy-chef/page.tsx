...
export default function FlappyChefPage() {
  return (
    <main className="w-full min-h-screen bg-black relative flex flex-col items-center pt-8 pb-12 px-4 overflow-hidden select-none">
      ...
      <div className="w-full max-w-4xl flex items-center justify-between z-10 mb-8">
        ...
        <div className="flex items-center gap-4">
          <a 
            href="https://flappychef.poseidon0z.com"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 text-[#22d3ee] hover:text-[#06b6d4] transition-colors duration-150 font-mono text-xs uppercase"
          >
            <span>Play Fullscreen</span>
            <ExternalLink className="w-3.5 h-3.5" />
          </a>
          <span className="text-white/30 font-mono text-xs">|</span>
          <span className="text-[#22d3ee] font-mono tracking-widest text-sm uppercase">Cabinet #01</span>
        </div>
      </div>

      {/* Arcade cabinet display */}
      <div className="relative w-full max-w-2xl bg-neutral-900 border-4 border-[#22d3ee] rounded-3xl p-4 sm:p-6 shadow-[0_0_30px_rgba(6,182,212,0.3)] z-10 flex flex-col items-center">
        ...
        <div className="w-full bg-black border-2 border-white/10 rounded-xl py-3 px-6 mb-6 flex flex-col items-center">
          <h1 
            ...
            style={{ textShadow: "0 0 8px rgba(6, 182, 212, 0.95)" }}
          >
            Flappy Chef
          </h1>
        ...
        {/* Screen Bezel - Optimized aspect to fit both portrait gameplay and landscape views */}
        <div className="relative w-full max-w-[576px] h-[480px] sm:h-[600px] bg-neutral-950 rounded-2xl border-4 border-neutral-800 p-2 sm:p-4 flex items-center justify-center overflow-hidden shadow-inner bg-black">
          ...
          {/* CRT Screen Glow */}
          <div className="absolute inset-0 bg-[#22d3ee]/5 pointer-events-none z-0" />

          {/* Game Area */}
          <div className="relative w-full h-full rounded-lg overflow-y-auto bg-black z-20">
            <iframe 
              src="/api/proxy-flappy" 
        ...
        <div className="w-full mt-6 bg-neutral-950 border border-white/5 rounded-2xl p-4 flex justify-between items-center">
          ...
          <div className="flex gap-3 items-center">
            <span className="text-white/40 font-mono text-xs uppercase">Joystick 1</span>
